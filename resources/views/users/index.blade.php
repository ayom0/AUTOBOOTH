...
<!-- Mirrored from html.vikinglab.agency/renev/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Mar 2025 04:44:31 GMT -->
<head>
     <meta charset="UTF-8">
...
<!--===== HERO AREA STARTS =======-->
<div class="hero1-section-area" style="background-image: url(assets/img/all-images/bg/hero-bg1.png); background-position: center top; background-repeat: no-repeat; background-size: cover;">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7">
        <div class="hero-header-area">
          <h5><img src="assets/img/icons/bundar1.png" alt=""> Klik, Pose, Happy!</h5>
          <div class="space32"></div>
          <h1 class="text-anime-style-3">Photobooth-nya <img src="assets/img/elements/elements1.png" alt="" class="elements1 keyframe5"></h1>
          <div class="space40 d-md-block d-none"></div>
          <div class="space16 d-block d-md-none"></div>
          <h1 class="text-anime-style-3"> Anak Hits Ada di Sini!</h1>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        <div class="imges-header">
          ...
          <div class="arrow">
            <a href="contact.html">
              <img src="assets/img/elements/elements37.png" alt="" class="keyframe5">
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-12">
        <div class="hero-bottom-images">
          ...
          <div class="img1 image-anime reveal">
            <img src="assets/img/all-images/hero/frame1.png" alt="">
          </div>
          <div class="started-btn">
            <svg xmlns="http://www.w3.org/2000/svg" width="190" height="190" viewBox="0 0 190 190" fill="none" class="keyframe5">
            ...
            <a href="contact.html"><span><i class="fa-solid fa-arrow-right"></i></span></a>
            <div class="space10"></div>
            <a href="contact.html">Lihat Detail</a>
          </div>
        </div>
      </div>
    </div>
...
<!--===== BLOG AREA STARTS =======-->
<div class="vl-keunggulan-1-area sp7" style="background-image: url(assets/img/all-images/bg/bg1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
  <div class="container">
     <div class="row">
...
<section class="testimonials-2 sp6" style="background-image">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 m-auto text-center">
      <div class="heading-feedback">
  <h5>
    <img src="assets/img/icons/lingkaran2.png" alt=""> Real Feedback
  </h5>
  <div class="space20"></div>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="testimonial-boxarea">
                ...
                <p>“Acara gue jadi makin seru gara-gara Photobooth X! Wajib cobain!. Efek filternya bikin gue keliatan glowing! Suka banget!” </p>
                <div class="space32"></div>
                <div class="names-area">
                  <div class="man-textarea">
                    <div class="man">
                      <img src="assets/img/all-images/testimonial/testimonial1.png" alt="">
                    </div>
                    <div class="text">
                      <a href="team.html">Bachtiar Julian</a>
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="portfolio-header heading1 space-margin60">
            <h5><img src="assets/img/icons/lingkaran3.png" alt="">ALBUM KAMI</h5>
            <div class="space24"></div>
...
<!--===== BLOG AREA STARTS =======-->
<div class="vl-blog-1-area sp7" style="background-image: url(assets/img/all-images/bg/bg1.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
  <div class="container">
     <div class="row">
        <div class="col-lg-7 m-auto">
        <div class="vl-blog-header heading1 text-center space-margin60">
  <h5 class="vl-blog-subtitle">
    <span><img src="assets/img/icons/lingkaran2.png" alt=""></span>BLOG DAN BERITA
  </h5>
  <div class="space24"></div>
  <h2 class="vl-section-title text-anime-style-3">BERITA TERKINI DARI AUTOBOOTH</h2>
</div>
        ...
        <div class="vl-blog-1-item">
           ...
           <div class="vl-blog-1-content">
            <div class="vl-blog-meta">
               <ul>
                <li><a href="#"><img src="assets/img/icons/calender.png" alt=""> 8 December 2024</a></li>
                
               </ul>
            </div>
            <div class="space14"></div>
            <h4 class="vl-blog-1-title"><a href="blog-single.html">Why Branding & Identity Design Business Matter More Than Ever</a></h4>
            <div class="space20"></div>
            <div class="vl-blog-1-icon">
              <a href="blog-single.html">Learn More <i class="fa-solid fa-arrow-right"></i></a>
           </div>
         </div>
        </div>
     </div>
     <div class="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration="1000">
        <div class="vl-blog-1-item">
           ...
           <div class="vl-blog-1-content">
              ...
              <div class="space14"></div>
              <h4 class="vl-blog-1-title"><a href="blog-single.html">The Complete Guide to Building A High-Converting Best Website</a></h4>
             <div class="space20"></div>
              <div class="vl-blog-1-icon">
                <a href="blog-single.html">Learn More <i class="fa-solid fa-arrow-right"></i></a>
             </div>
     ...
     <div class="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration="1000">
      <div class="vl-blog-1-item">
         ...
         <div class="vl-blog-1-content">
            ...
            <div class="space14"></div>
            <h4 class="vl-blog-1-title"><a href="blog-single.html">Effective SEO Digital Marketing Strategies to Grow Your Brand</a></h4>
            <div class="space20"></div>
            <div class="vl-blog-1-icon">
              <a href="blog-single.html">Learn More <i class="fa-solid fa-arrow-right"></i></a>
           </div>
...
<!-- Mirrored from html.vikinglab.agency/renev/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Mar 2025 04:45:10 GMT -->
</html>